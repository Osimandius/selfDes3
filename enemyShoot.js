AFRAME.registerComponent("enemy-bullets", {
    ...
    shootEnemyBullet: function () {
        ...
        for (var i = 0; i < els.length; i++) {
            ...
            e1.setAttribute("animation-mixer", { clip: "honk", loop:"repeat",crossFadeDuration:0.1})
            setTimeout(() => { e1.setAttribute("animation-mixer", { clip: "HoldTubaWalk",loop:"repeat" }) }, 620)
